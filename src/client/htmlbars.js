define(['exports'], function (exports) {
  ...
  function inline(env, morph, context, path, params, hash) {
    var helper = lookupHelper(env, context, path);
  ...
  function content(env, morph, context, path) {
    var helper = lookupHelper(env, context, path);
  ...
  function element(env, domElement, context, path, params, hash) {
    var helper = lookupHelper(env, context, path);
    if (helper) {
  ...
  function attribute(env, attrMorph, domElement, name, value) {
    attrMorph.setContent(value);
  }

  function subexpr(env, context, helperName, params, hash) {
  ...
  function set(env, context, name, value) {
    context[name] = value;
  }

  function component(env, morph, context, tagName, attrs, template) {
